...
export const ENV_CONFIG = {
  ...
  HOT_POTATO_DB_SPREADSHEET_NAME: getEnvVar('VITE_HOT_POTATO_DB_SPREADSHEET_NAME'),
  BOARD_SPREADSHEET_NAME: getEnvVar('VITE_BOARD_SPREADSHEET_NAME'),
  ANNOUNCEMENT_SPREADSHEET_NAME: getEnvVar('VITE_ANNOUNCEMENT_SPREADSHEET_NAME'),
  CALENDAR_PROFESSOR_SPREADSHEET_NAME: getEnvVar('VITE_CALENDAR_PROFESSOR_SPREADSHEET_NAME'),
  CALENDAR_STUDENT_SPREADSHEET_NAME: getEnvVar('VITE_CALENDAR_STUDENT_SPREADSHEET_NAME'),
  STUDENT_SPREADSHEET_NAME: getEnvVar('VITE_STUDENT_SPREADSHEET_NAME'),
  STAFF_SPREADSHEET_NAME: getEnvVar('VITE_STAFF_SPREADSHEET_NAME'),
  
  // 시트 이름들 (원래 코드와 동일하게 수정)
  BOARD_SHEET_NAME: getEnvVar('VITE_BOARD_SHEET_NAME'),
  ANNOUNCEMENT_SHEET_NAME: getEnvVar('VITE_ANNOUNCEMENT_SHEET_NAME'),
  CALENDAR_SHEET_NAME: getEnvVar('VITE_CALENDAR_SHEET_NAME'),
  DOCUMENT_TEMPLATE_SHEET_NAME: getEnvVar('VITE_DOCUMENT_TEMPLATE_SHEET_NAME'),
  STUDENT_SHEET_NAME: getEnvVar('VITE_STUDENT_SHEET_NAME'),
  STUDENT_ISSUE_SHEET_NAME: getEnvVar('VITE_STUDENT_ISSUE_SHEET_NAME'),
  STAFF_INFO_SHEET_NAME: getEnvVar('VITE_STAFF_INFO_SHEET_NAME'),
  STAFF_COMMITTEE_SHEET_NAME: getEnvVar('VITE_STAFF_COMMITTEE_SHEET_NAME'),
  DASHBOARD_SHEET_NAME: getEnvVar('VITE_DASHBOARD_SHEET_NAME'),
